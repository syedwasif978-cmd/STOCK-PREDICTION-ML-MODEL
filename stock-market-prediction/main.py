"""
===============================================================================
STOCK MARKET ANALYSIS & PREDICTION SYSTEM - MAIN ENTRY POINT
===============================================================================

Project Overview:
    This is a machine learning-based stock market analysis and prediction
    system. It analyzes historical market data, extracts technical indicators,
    trains a Random Forest model, and predicts next-day returns.

Main Workflow:
    1. User Input: Stock symbol (e.g., NVDA, AAPL, TSLA)
    2. Data Fetch: Retrieve 5 years of historical data from Alpaca API
    3. Feature Engineering: Calculate technical indicators (SMA, RSI, Volatility)
    4. Data Preparation: Remove NaN values, split train/test
    5. Model Training: Train Random Forest on 70% of data
    6. Model Evaluation: Test on 30% holdout set
    7. Visualization: Plot actual vs predicted prices
    8. Display Results: Show predictions and metrics

Key Features:
    ✓ Real-world market data via Alpaca Markets API
...
System Requirements:
    - Python 3.7+
    - Libraries: pandas, numpy, scikit-learn, matplotlib, alpaca-trade-api
    - Alpaca Markets API Key (free account available)
...
Setup Instructions:
    ...
    2. Get Alpaca API credentials:
       ...
       - Set environment variables:
         Windows: set APCA_API_KEY_ID=your_key
...
Usage Examples:
    ...
    Stock symbol to analyze: NVDA
    
    # Example 2: Analyze AAPL
    Stock symbol to analyze: AAPL
    
    # Example 3: Analyze TSLA
    Stock symbol to analyze: TSLA

Expected Output:
    - Console: Training progress, metrics, feature importance
    - Plots: actual_vs_predicted.png, returns_analysis.png
    - Report: model_report.txt
    - Data: predictions.csv with all predictions

Dependencies & Imports:
    - api.alpaca_fetch: Stock data retrieval
    - indicators.sma, indicators.rsi, indicators.volatility: Technical indicators
    - model.train: Data prep and model training
    - model.predict: Making predictions
    - model.random_forest: RandomForestModel class
    - visualization.plot_results: Plotting and reporting
